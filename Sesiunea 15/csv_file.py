...
def read(filename):
    with open(filename,'r') as f:
        reader = csv.reader(f) #iterator peste toate liniile din fisierul f si returneaza fiecare linie ca lista de valori
        return list(reader)
...
write_dict('persoana2.csv',data2)
